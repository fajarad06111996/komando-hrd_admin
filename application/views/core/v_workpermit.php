...
<div id="mForm" data-backdrop="static" data-keyboard="false" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="" id="myForm" class="form-horizontal form-validasi" accept-charset="utf-8"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-10">
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-md-9">
                                    <select id="dept_idx" name="dept_idx" data-placeholder="- Pilih Organisasi -"
                                        ...
                                        <option value="<?= $this->secure->enc($e->idx); ?>"><?= $e->department_name; ?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row mb-1">
                                <label class="col-form-label col-sm-3 text-uppercase text-right">Nama Jabatan<sup><b
                                            class="text-danger">*</b></sup></label>
                                <div class="col-md-9">
                                    <?= csrf_input(); ?>
                            ...
                            <div class="form-group row mb-1">
                                <label class="col-form-label col-sm-3 text-uppercase text-right">Deskripsi<sup><b
                                            class="text-danger">*</b></sup></label>
                                <div class="col-md-9">
                                    <textarea rows="4" id="description" name="description" type="text"
                                        placeholder="Deskripsi" class="form-control form-control-sm"
                                        required></textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-md-9">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <!-- tBnaktif -->
                                            <input type="radio" value="1" class="form-check-input-styled" name="tStatus"
                                                id="xTrue">Aktif
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <!-- tBaktif -->
                                            <input type="radio" value="0" class="form-check-input-styled" name="tStatus"
                                                id="xFalse">Non-Aktif
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary btn-ladda btn-ladda-spinner bSbmit"
                            data-spinner-color="#333" data-style="slide-down">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
...
<div class="panel panel-blue">
    <div class="panel-heading">Master Ijin Kerja
        <?= $write; ?>
    </div>
