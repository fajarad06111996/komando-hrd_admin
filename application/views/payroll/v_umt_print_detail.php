...
<html lang="en">
    ...
    <body>
		<table cellspacing="0" cellpadding="3" border="0" style="font-size:5.5px; width:100%">
            ...
            ?>
			<tr style="color:#000;">
				<td colspan="<?= $headerCount; ?>" class="border-full" align="center" style="width:100%;font-size:9px;"><b><?= $company['company_name']; ?></b></td>
			</tr>
			<tr style="color:#000;">
                ...
                <?php 
                    ...
                    $setViewDate   = 17;
                    if($setViewDate>$iDate){
                        $addingDate = $setViewDate-$iDate;
                    }else{
                        $addingDate = 0;
                    }
                    for ($i=0; $i < $addingDate; $i++) { 
                ?>
                <th class="border-full bg-header" align="center" style="width:3.6%;">-</th>
                <?php } ?>
            ...
            <tr>
                ...
                <?php 
                    ...
                    $setViewDate2 = 17;
                    if($setViewDate2>$iDate2){
                        $addingDate2 = $setViewDate2-$iDate2;
                    }else{
                        $addingDate2 = 0;
                    }
                    for ($i2=0; $i2 < $addingDate2; $i2++) { 
                ?>
                <th class="border-full bg-header" align="center" style="width:3.6%;">-</th>
                <?php } ?>
            </tr>
            ...
            <?php } ?>
            <tr>
                <td colspan="<?= $footerCount; ?>" align="left" style="width:66.7%;font-size:9px;">Jakarta, <?= date('d-F-Y', strtotime($dataHeader['created_on'])); ?></td>
