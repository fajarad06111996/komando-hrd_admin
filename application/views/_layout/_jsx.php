  ...
  <!-- <script src="<?= base_url(); ?>assets/jquery-easyui-1.5/jquery.easyui.min.js"></script> -->
  ...
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/extensions/jquery_ui/core.min.js"></script>
  ...
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/sweetalert2/sweetalert2.min.js?v=1.1"></script>
  ...
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/ui/perfect_scrollbar.min.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/layout_fixed_sidebar_custom.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/forms/validation/validate.min.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/form_validation.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/form_inputs.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/ckeditor/ckeditor.js"></script>
  <!-- Theme JS files -->
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/editors/ace/ace.js"></script>
  ...
  <!-- <script src="<?= base_url(); ?>assets/global_assets/js/plugins/trees/fancytree_all.min.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/trees/fancytree_childcounter.js"></script> -->
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/loaders/progressbar.min.js"></script>

  <!-- <script src="<?= base_url(); ?>assets/global_assets/js/plugins/trees/fancytree_childcounter.js"></script> -->
  
  <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.2/bootstrap3-typeahead.min.js"></script>   -->
	<!-- <script src="<?= base_url(); ?>assets/global_assets/js/plugins/forms/inputs/typeahead/typeahead.bundle.min.js"></script> -->
	<script src="<?= base_url(); ?>assets/global_assets/js/plugins/forms/inputs/typeahead/bootstrap3-typeahead.js"></script>
	<!-- <script src="<?= base_url(); ?>assets/global_assets/js/plugins/forms/inputs/typeahead/handlebars.min.js"></script> -->
  ...
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/uploaders/fileinput/fileinput.min.js"></script>
	<script src="<?= base_url(); ?>assets/global_assets/js/plugins/forms/inputs/autosize.min.js"></script>
	<script src="<?= base_url(); ?>assets/global_assets/js/plugins/media/fancybox.min.js"></script>
  ...
  <script src="<?= base_url(); ?>assets/layout1/js/app.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/components_popups.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/animations_css3.js"></script>
  <script src="<?= base_url(); ?>assets/layout1/js/notifikasi.js?v=1.0"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/form_select2.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/plugins/jquery.maskedinput/jquery.maskedinput.min.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/components_buttons.js"></script>
	<script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/gallery.js"></script>
  <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/uploader_bootstrap.js"></script>
	<script src="<?= base_url(); ?>assets/layout1/js/datatables_extension_buttons_html5.js"></script>
  <!-- <script src="http://demo.interface.club/limitless/demo/Template/global_assets/js/demo_pages/uploader_bootstrap.js"></script> -->
  <!-- <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/jqueryui_components.js"></script> -->
  <!-- <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/components_progress.js"></script> -->
  <!-- <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/extra_jgrowl_noty.js"></script> -->
  <!-- <script src="<?= base_url(); ?>assets/layout1/js/jquery-ui.js"></script> -->
  <script src="<?= base_url(); ?>assets/layout1/js/jquery.numeric.js"></script>
	<!-- <script src="<?= base_url(); ?>assets/global_assets/js/demo_pages/form_controls_extended.js"></script> -->
  <script src="<?= base_url(); ?>assets/layout1/js/custom.js?v=1.1"></script>
  
  <script type="text/javascript">
    $(document).ready(function() {
      $(".se-pre-con2").fadeOut("slow");
      $('.text-numeric').numericOnly();
      autosize($('.elastic'));
    });
    function myFunction() {
