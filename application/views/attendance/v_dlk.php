...
<div class="container bg-white">
	<div class="row">
		<div class="col-lg-12">
			<h5 align="center">DINAS LUAR KOTA</h5>
			<div id="calendar"></div>
...
<div class="modal fade" id="header_dlk_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalLabel">Tambah DLK</h5>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
            <form action="" id="dlkHForm" class="form-horizontal form-validasi" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <div class="modal-body">
                    <div class="img-container">
                        <div class="row">
                            <div class="col-sm-12">  
                                <div class="form-group">
                                    <label for="dlk_date">Tanggal DLK<sup><b class="text-danger">*</b></sup></label>
                                    <input type="date" name="dlk_date" id="dlk_date" class="form-control onlydatepicker" placeholder="Event date" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<!-- Modal Table Detail -->
<div class="modal fade" id="detail_dlk_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog modal-super" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalLabel">Detail DLK</h5>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
            <div class="modal-body">
                <!-- Detail Goods -->
                <div class="panel panel-blue">
                    <div class="panel-heading">Detail DLK <span class="tDLK"></span>
                        <div class="pull-right block-options">
                            <a href="javascript:void(0);" id="btnAdd" dlkid="" dlkdate="" class="pull-right text-white small" title="Tambah DLK" data-placement="right" data-popup="tooltip"><i class="icon-plus-circle2"></i></a>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="tbDLK" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
...
<div id="add_detail_dlk_modal" data-backdrop="static" data-keyboard="false" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="" id="dlkForm" class="form-horizontal form-validasi2" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <div class="col-sm-6">  
                            <div class="form-group row mb-1">
                                <?= csrf_input(); ?>
                                <input type="hidden" name="dlk_idx" value="">
                                <input type="hidden" name="dlk_date" value="">
                            ...
                            <div class="form-group row mb-1">
                                <label class="col-form-label col-sm-3 text-right">Nilai DLK<sup><b class="text-danger">*</b></sup></label>
                                <div class="form-group col-md-8">
									<input name="value" type="text" class="form-control form-control-sm moneyx" placeholder="0" required data-msg="Nilai DLK wajib di isi."/>
								</div>
                            </div>
                            <div class="form-group row mb-1">
                ...
                <div class="modal-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        <button type="button" data-dismiss="modal" class="btn btn-outline-secondary">Batal</button>&nbsp;&nbsp;&nbsp;
                        <button type="submit" dlkid="" class="btn btn-primary btn-ladda btn-ladda-spinner bSbmit" data-spinner-color="#333" data-style="slide-down">Simpan</button>
                    </div>
                    <!-- <button type="button" class="btn btn-primary" onclick="save_event()">Save Event</button> -->
                </div>
            </form>
...
<script src="<?= base_url(); ?>assets/layout1/js/attendance/v_dlk.js?v=0.1" params='<?= $params; ?>'></script>