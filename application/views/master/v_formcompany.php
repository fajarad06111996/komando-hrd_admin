    ...
    <div class="col-md-12">
        <div class="card panel panel-blue">
            ...
            <div class="block-header text-center">
                <span class="block-title">CENTER POINT <?= !empty($off)?$off['company_name']:'';?></span>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row mb-1">
                                    <label class="col-form-label col-sm-3 text-right">Company Code<sup><b class="text-danger">*</b></sup></label>
                                    <div class="col-md-9">
                                        <?= csrf_input(); ?>
                                        ...
                                        <input name="company_code" type="text" value="<?= !empty($off)?$off['company_code']:'';?>" placeholder="Company Code" class="form-control form-control-sm" <?= empty($off)?'':'readonly';?> required data-msg="Company Code is required."/>
                                    </div>
                                </div>
                                <div class="form-group row mb-1">
                                    <label class="col-form-label col-sm-3 text-right">Company Name<sup><b class="text-danger">*</b></sup></label>
                                    <div class="col-md-9">
                                        <input name="company_name" type="text" value="<?= !empty($off)?$off['company_name']:'';?>" placeholder="Company Name" class="form-control form-control-sm" required data-msg="Company Name is required."/>
                                    </div>
                                </div>
                                <div class="form-group row mb-1">
...
<script src="<?= base_url(); ?>assets/layout1/js/master/v_formcompany.js?v=0.1" params='<?= $params; ?>'></script>
<script src="https://maps.googleapis.com/maps/api/js?key=<?= key_google(); ?>&loading=async&libraries=places&callback=initMap" async defer></script>