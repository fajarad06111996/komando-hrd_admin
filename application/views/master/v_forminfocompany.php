            ...
            <div class="block-content font-size-sm mb-5">
                <div class="row">
                    <div class="col-md-6">
                        <table class="table">
                            <tr>
                                <td class="text-right"><strong>Company Code</strong></td>
                                <td class="text-left">: <?= $off['company_code'] ?></td>
                            </tr>
                            <tr>
...
<script src="<?= base_url(); ?>assets/layout1/js/master/v_forminfocompany.js?v=0.1" params='<?= $params; ?>'></script>
