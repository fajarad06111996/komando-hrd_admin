						...
						<div class="block-content font-size-sm">
							<div class="row">
								<div class="col-md-6">
									<table class="table">
										<tr>
											<td class="text-right"><strong>Office Type</strong></td>
											<td class="text-left oType"></td>
										</tr>
										<tr>
...
<script src="<?= base_url(); ?>assets/layout1/js/master/v_office.js?v=0.1" params='<?= $params; ?>'></script>