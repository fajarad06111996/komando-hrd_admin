...
var FormValidation = function() {
    ...
    var _componentValidation = function() {
        ...
        var validator = $('.form-validasi').validate({
            // ignore: 'input[type=hidden], .select2-search__field .select-search', // ignore hidden fields
        ...
        var validator = $('.form-validasi2').validate({
            ignore: 'input[type=hidden], .select2-search__field .select-search', // ignore hidden fields
            errorClass: 'validation-invalid-label',
            successClass: 'validation-valid-label',
            validClass: 'validation-valid-label',
        ...
        var validator = $('.form-validasi3').validate({
            ignore: 'input[type=hidden], .select2-search__field .select-search', // ignore hidden fields
            errorClass: 'validation-invalid-label',
            successClass: 'validation-valid-label',
            validClass: 'validation-valid-label',
        ...
        var validator = $('.form-validasi4').validate({
            ignore: 'input[type=hidden], .select2-search__field .select-search', // ignore hidden fields
            errorClass: 'validation-invalid-label',
            successClass: 'validation-valid-label',
            validClass: 'validation-valid-label',
        ...
        var validator = $('.form-validasi5').validate({
            ignore: 'input[type=hidden], .select2-search__field .select-search', // ignore hidden fields
            errorClass: 'validation-invalid-label',
            successClass: 'validation-valid-label',
            validClass: 'validation-valid-label',
        ...
        var validator = $('.f-validasi').validate({
            ignore: 'input[type=hidden], .select2-search__field .select-search', // ignore hidden fields
            errorClass: 'text-danger font-size-xs',
            successClass: 'validation-valid-label',
            validClass: 'validation-valid-label',
            highlight: function(element, errorClass) {
                $(element).removeClass(errorClass);
        ...
        var validator = $('.fvalidasi').validate({
            ignore: 'input[type=hidden], .select2-search__field .select-search', // ignore hidden fields
